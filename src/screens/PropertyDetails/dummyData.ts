...
export const DUMMY_PROPERTIES: PropertyCardProps[] = [
  {
    ...
    approvedValuation: 7000000,
    availableUnits: 69985,
    totalUnits: 70000,
    riskScore: 3.4,
    description: "Traditional Japanese cottage with modern fractional ownership."
  },
  {
  ...
  },
  {
    ...
    name: "The Krrish Villa",
    location: "Mumbai",
    imageUrl: "https://images.unsplash.com/photo-1518780664697-55e3ad937233?auto=format&fit=crop&w=800&q=80",
    propertyType: "Commercial",
    annualYieldPercent: 6.7,
    approvedValuation: 15000000,
    availableUnits: 12000,
    totalUnits: 12000,
    riskScore: 5.0,
    description: "Spacious villa with stable rental returns in a premium district."
  }
];