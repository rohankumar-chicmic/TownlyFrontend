...
const SWAP_THRESHOLD = SCROLL_DISTANCE * 0.35;
...
const SPHERE_CONFIG = [
  {
    ...
    finalSlot: 0,
    key: 'perform',
    xEnd: SCROLL_DISTANCE * 0.2,
    yEnd: SCROLL_DISTANCE * 0.7,
    scaleEnd: SCROLL_DISTANCE * 0.2,
  },
  {
    row: 0,
    col: 1,
...
function AnimatedSphereWrapper({
  ...
  // Pure math — no manual offsets so all 4 final gaps are identical
  ...
  // ── Legend wrapper: slides from offset → centre + counter-scales ──
